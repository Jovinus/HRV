...
if __name__ == '__main__':
    ...
    rkf = RepeatedKFold(n_splits=10, n_repeats=1, random_state=11004)
    ...
    for cv_num, (train_id, test_id) in enumerate(rkf.split(subject)):
        ...
        logger = TensorBoardLogger("tb_logs", name="only_train_cv1", version=cv_num)
        
        # checkpoint_callback = ModelCheckpoint(monitor='val_loss',
        #                               dirpath='check_point/only_train_cv1_'+str(cv_num), 
    ...
    df_metric.reset_index(drop=True).to_csv("./only_train_cv1_results.csv", index=False)
# %%
