...
class Residual_CNN_Model(pl.LightningModule):
    def __init__(self, output_class):
        ...
        self.linear = nn.Sequential(nn.Linear(2000, 1000),
        ...
        self.gru = nn.GRU(input_size=598, hidden_size=1000, num_layers=4, batch_first=True, dropout=0.6, bidirectional=True)
